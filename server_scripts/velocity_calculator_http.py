...
username = folder_name.split('_')[1]
print(folder_path)
print(folder_name)
print(uid)
print(username)

shutil.copyfile(os.path.join(folder_path, f'AlphaPose_{folder_name}.mp4'),
                os.path.join('/home/saman/Desktop/Git/pose_tracker_web/posetrackerweb/main/result_videos', f'{folder_name}.mp4'))
...
data = {'id': uid, 'username': username, 'velocity': final_velocity}
requests.post('http://localhost:40000/setresult/', data=data)
